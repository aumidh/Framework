...
public class StopWatch {
	...
	public void addManualTask(String _taskName,long _totalMilis) throws IllegalStateException {
		this.totalTimeMillis += _totalMilis;
		//this.lastTaskInfo
		TaskInfo t= new TaskInfo(_taskName, _totalMilis);
		if (this.keepTaskList) {
			this.taskList.add(t);
		}
		++this.taskCount;
